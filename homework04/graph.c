         ...
         int* color, int* distance, int* parent)
{
    ...
    // Initialize queue and make sure it's properly allocated
    ...
    // Increment the number of elms in the queue
    elms_in_q++;
    ...
    // Decrement the number of elms in the queue
    elms_in_q--;
    ...
    //  Go through all of u's neighbors
        ...
        // Create a node to represent v in  queue
